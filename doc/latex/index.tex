...
Welcome to a brief introduction of a project executed by a student of the university of Kassel. ~\newline
 The goal of this project is to create reliable software that controls the robot so it drives three laps on a track (\href{track_img.jpg}{\tt {\bfseries example track}}) consisting of a black line, autonomously. ~\newline
